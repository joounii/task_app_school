                    ...
                    {props.tasks.map(task => {
                        return (
                            <tr key={task.id}>
                                ...
                                <td>
                                    <button className="btn btn-success bi bi-pencil" onClick={() => changeCompleteState(task)}> Change status</button>
                                </td>
                                <td>
                                    <button className="btn btn-danger bi bi-trash3" onClick={() => deleteAlert(task)}> Delete</button>
                                </td>
                            </tr>
                        );
                    })}
